...
- Käivita `source .venv/bin/activate && locust -f tests-performance-locust/locustfile.py --headless -u 50 -r 5 --run-time 5m --host http://localhost:8000 --csv docs/results/locust/koormus`.
