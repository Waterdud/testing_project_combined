...
- Käivita `source .venv/bin/activate && pytest tests-integration -v`, salvesta logi `docs/results/integration/integration.log` ja lisa pass/fail tingimus testiplaanis.
